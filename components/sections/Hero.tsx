...
import { CTA_PATH, localeAnchor, localeHref } from "@/lib/menu";
        ...
        <div className="row align-items-center">
          <div className="col-xl-8">
            <div className="hero-style8">
              <span className="sub-title style3 text-anime-style-2">{t("eyebrow")}</span>
              ...
              <div className="hero-wrapp">
                <div className="btn-group justify-content-center justify-content-xl-start">
                  ...
                  <a
                    href={localeAnchor(locale, "approach")}
